          ...
          <div className="home-hero__content home-hero__anim">
            ...
            <div className="home-hero__actions">
              <Link to="/tasks" className="home-hero__btn home-hero__btn--primary">
                <span>לצפיה במשימות</span>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 5 5 12 12 19"/></svg>
              </Link>
